...
const PATHS = {
  ...
  info:         '<circle cx="12" cy="12" r="9"/><path d="M12 11.5v4.5"/><path d="M12 7.8h.01"/>',
  /* The GitHub mark is one filled silhouette, not a stroked outline — it only
     reads as GitHub at this exact shape, so it opts out of the stroke style. */
  ...
  /* ---- shared spaces ---- */
  users:        '<path d="M16 20v-1.8a3.6 3.6 0 0 0-3.6-3.6H6.6A3.6 3.6 0 0 0 3 18.2V20"/><circle cx="9.5" cy="7.5" r="3.5"/><path d="M21 20v-1.8a3.6 3.6 0 0 0-2.7-3.48"/><path d="M15.5 4.2a3.5 3.5 0 0 1 0 6.6"/>',
  "user-plus":  '<path d="M15 20v-1.8a3.6 3.6 0 0 0-3.6-3.6H5.6A3.6 3.6 0 0 0 2 18.2V20"/><circle cx="8.5" cy="7.5" r="3.5"/><path d="M19 8v6M22 11h-6"/>',
  camera:       '<path d="M22 18a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2.5l1.6-2.4A1 1 0 0 1 9 4h6a1 1 0 0 1 .84.45L17.5 7H20a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="3.5"/>',
  copy:         '<rect x="8.5" y="8.5" width="12" height="12" rx="2.5"/><path d="M15.5 5.5v-1a2 2 0 0 0-2-2h-8a3 3 0 0 0-3 3v8a2 2 0 0 0 2 2h1"/>',
  share:        '<circle cx="18" cy="5" r="2.8"/><circle cx="6" cy="12" r="2.8"/><circle cx="18" cy="19" r="2.8"/><path d="m8.4 10.7 7.2-4.2M8.4 13.3l7.2 4.2"/>',
  "log-out":    '<path d="M15 4h3a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-3"/><path d="m10 16-4-4 4-4M6 12h10"/>',
  key:          '<circle cx="7.5" cy="14.5" r="4.5"/><path d="m11 11 8.5-8.5M17 5l2.5 2.5M14.5 7.5 17 10"/>',
  "more":       '<circle cx="5" cy="12" r="1.6" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.6" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1.6" fill="currentColor" stroke="none"/>',
  "qr-code":    '<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><path d="M14 14h3v3h-3zM21 14v3M18 21h3M14 21h1"/>',
  archive:      '<path d="M3 8h18v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><rect x="2" y="3" width="20" height="5" rx="1.5"/><path d="M10 12h4"/>',
